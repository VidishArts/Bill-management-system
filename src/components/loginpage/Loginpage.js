                ...
                <div className="row g-0">
                    ...
                    <div className="card-body p-md-2 mx-md-4">
                      <div className="text-center mt-3">
                        <img
                          ...
                          alt="logo"
                        />
                        <h4 className="mt-1 mb-5 pb-1">Bill Management Form</h4>
                      </div>
                      ...
                      <form onSubmit={handleSubmit} className=''  >
                        ...
                        <div className="form-outline  mb-4">
                          ...
                          /> <p style={{color:'red'}} >{emailerror? "Invalid Entry":""}</p>
                        </div>
                        ...
                        <div className="form-outline mb-4">
                          ...
                          /> <p style={{color:'red'}}>{passwordrerror? "Weak Password":""}</p>
                        </div>
                        ...
                        <div className="text-center pt-1 mb-5 pb-1">
                          ...
                          <div className="icon">
                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="100" viewBox="0 0 30 30">
                            ...
                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="100" viewBox="0 0 50 50">
                            ...
                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="100" viewBox="0 0 48 48">
                  ...
                  <div className="col-lg-6 d-flex align-items-center gradient-custom-2">
                    <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                      <h4 className="mb-4">You will find Customer List and Bill Generator</h4>
                      <p className="small mb-0">
                        6 fields of  client name , product quantity, billing-date, contact-details , address and billing price.
                        <br />
                        <br />
                        A bill generator UI which contain some fields  Customer Name
                        Customer Mobile Number.
                        Customer Address.
                        Billing Date.
                        Add a functionality to add new input fields with labels (Product Name, Product Quantity, Product Price, Total Price).
                      </p>
                    </div>
                  </div>
                </div>
